...
(1) Clone the Google Genomics codelab repository.  From the RStudio *Main Menu*:
  ...
  .. image:: /_static/create_git_project.png
    :alt: Create Git Project Dialog
    :align: right
    :height: 100px
    :width: 200px
...
(2) Open the codelab RMarkdown file.  From the RStudio *Files Pane*:
  ...
  .. image:: /_static/open_rmarkdown.png
    :alt: Navigate to RMarkdown
    :align: right
    :height: 100px
    :width: 200px
...
(3) Set your current working directory.  From the RStudio *Files Pane*:
  ...
  .. image:: /_static/set_working_directory.png
    :alt: Set Working Directory
    :align: right
    :height: 100px
    :width: 200px
